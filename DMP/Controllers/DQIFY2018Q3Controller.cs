...
{
    public class DQIFY2018Q3Controller : Controller
    {
        ...
        public ActionResult ComparsionWithQ3(string report_type = "partners")
        {
            string ip = "";
            if (User.IsInRole("ip"))
            {
            ...
            cmd.Parameters.AddWithValue("@secondPeriod", "Q3 FY18");
            cmd.Parameters.AddWithValue("@firstPeriod", "Q2 FY18");
        ...
        public ActionResult DownloadDQITool()
        {
            ...
            var DQISites = new QIEngine().GetQISites("Q3 FY18", ip);
        ...
        {
            string fileName = "DQI_Q3_FY18_" + data.IP + ".xlsm";
            string directory = System.Web.Hosting.HostingEnvironment.MapPath("~/Report/Template/DQI/Q3 FY18/");
            string template = System.Web.Hosting.HostingEnvironment.MapPath("~/Report/Template/DQI/Q3 FY18/DQI TOOL_unlocked.xlsm");
        ...
        public string ProcessFile()
        {
            ...
            try
            {
                Logger.LogInfo("DQ2Q3 FY2018,ProcessFile", "processing dqi upload");
                ...
                if (Request.Files.Count > 0)
                {
                    ...
                    foreach (string file in Request.Files)
                    {
                        ...
                        {
                            var filePath = System.Web.Hosting.HostingEnvironment.MapPath("~/Report/Uploads/DQI Q3 FY18/" + postedFile.FileName);
                            postedFile.SaveAs(filePath);

                            messages += new QIEngine().ProcessUpload(filePath, userUploading, "Q3 FY18");
                        }
                        else
                        {
