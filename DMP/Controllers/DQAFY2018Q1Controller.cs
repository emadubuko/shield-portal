...
namespace ShieldPortal.Controllers
{
    public class DQAFY2018Q1Controller : Controller
    {
        ...
        public ActionResult UploadPivotTable()
        {
            ...
            {
                previousUploads = Utility.RetrievePivotTables(0, "Q1 FY18");
            }
            else
            {
                previousUploads = Utility.RetrievePivotTables(profile.Organization.Id, "Q1 FY18");
            }
        ...
        {
            new BDQAQ1FY18().DeletePivotTable(id);
                ...
                if (Request.Files.Count > 0)
                {
                    ...
                    foreach (string file in Request.Files)
                    {
                        ...
                        if (ext.ToUpper() == "XLS" || ext.ToUpper() == "XLSX" || ext.ToUpper() == "XLSM" || ext.ToUpper() == "ZIP")
                        {
                            ...
                            {
                                messages += new BDQAQ1FY18().ReadWorkbook(filePath, userUploading);
                            }
                        }
                        else
                        {
        ...
        public string GetDashboardStatistic()
        {
            ...
            var ds = Utility.GetDashboardStatistic(ip, "Q1 FY18");
        ...
        public ActionResult DQAResult()
        {
            ...
            var reports = Utility.GetUploadReport("Q1 FY18", ip);
        ...
        public async Task<ActionResult> DownloadDQATool(List<PivotTableModel> data)
        {
            ...
            string file = await new BDQAQ1FY18().GenerateDQA(data, profile.Organization);
