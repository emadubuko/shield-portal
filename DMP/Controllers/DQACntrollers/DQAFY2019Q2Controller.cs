...
{
    public class DQAFY2019Q2Controller : Controller
    {
        // GET: DQAFY2019Q2
        ...
        public ActionResult UploadPivotTable()
        {
            ...
            List<UploadList> previousUploads = Utility.RetrievePivotTables(ip_id, "Q2 FY19");
        ...
        public string ProcesssPivotTable(string reportPeriod)
        {
            ...
            else
            {
                ...
                bool status = new BDQAQ2FY19().ReadPivotTable(uploadedFile, reportPeriod, loggedinProfile, out result);
            }
            return result;
        }
        ...
        public ActionResult DQAResult()
        {
            ...
            var reports = Utility.GetUploadReport("Q2 FY19", ip);
        ...
        public ActionResult Analytics(string reportType = "Partners")
        {
            ...
            var datatable = Utility.GetFY19Analysis(ip, "Q2 FY19", reportType.ToLower().Contains("partners"));
        ...
        public string PostDQAFile()
        {
            ...
            try
            {
                ...
                Logger.LogInfo(" DQAQ2 FY2019,PostDQAFile", "processing dqa upload");
                    ...
                    foreach (string file in Request.Files)
                    {
                        ...
                        if (ext.ToUpper() == "XLS" || ext.ToUpper() == "XLSX" || ext.ToUpper() == "XLSM" || ext.ToUpper() == "ZIP")
                        {
                            string directory = System.Web.Hosting.HostingEnvironment
                                .MapPath("~/Report/Uploads/DQA Q2 FY19/"
                                + loggedinProfile.Organization.ShortName) + "/";
                            if (Directory.Exists(directory) == false)
                            {
                                Directory.CreateDirectory(directory);
                                    ...
                                    using (ZipFile zipFile = new ZipFile(fs))
                                    {
                                        ...
                                        foreach (ZipEntry zipEntry in zipFile)
                                        {
                                            ...
                                            if (entryExt.ToUpper() == "XLS" || entryExt.ToUpper() == "XLSX" || entryExt.ToUpper() == "XLSM")
                                            {
                                                ...
                                                messages += new BDQAQ2FY19().ReadWorkbook(extractedFilePath, loggedinProfile);
                                                countSuccess++;
                                            }
                                        }
                            ...
                            {
                                messages += new BDQAQ2FY19().ReadWorkbook(filePath, loggedinProfile);
                            }
                        }
                        else
                        {
        ...
        public ActionResult DQAAnalysisReport(string type)
        {
            ...
            cmd.Parameters.AddWithValue("@reportPeriod", "Q2 FY19");
        ...
        public ActionResult UMB_Partner_Report()
        {
            ...
            var partner_datatable = Utility.GetFY19Analysis(ip, "Q2 FY19", true);
            var umb_datatable = Utility.GetFY19Analysis(ip, "Q2 FY19", false);
        ...
        public async Task<ActionResult> DownloadDQAResource(string fileType)
        {
            ...
            {
                case "DQAUserGuide":
                    filename = "Data Quality Assessment Userguide Q2 FY19.pdf";
                    break;
                case "PivotTable":
                    filename = "DATIM PIVOT TABLE FOR Q2 FY19.xlsx";
                    break;
                case "SummarySheet":
                    filename = "Summary Sheet FY19 Q2 DQA.pdf";
                    break;
            }
            string path = System.Web.Hosting.HostingEnvironment.MapPath("~/Report/Template/DQA FY2019 Q2/" + filename);
