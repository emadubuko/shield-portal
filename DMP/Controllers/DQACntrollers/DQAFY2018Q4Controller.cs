...
namespace ShieldPortal.Controllers.DQACntrollers
{
    public class DQAFY2018Q4Controller : Controller
    {
        ...
        public ActionResult UploadPivotTable()
        {
            ...
            List<UploadList> previousUploads = Utility.RetrievePivotTables(ip_id, "Q4 FY18");
        ...
        public string ProcesssPivotTable(string reportPeriod)
        {
            ...
            else
            {
                ...
                bool status = new BDQAQ4FY18().ReadPivotTable(uploadedFile, reportPeriod, loggedinProfile, out result);
            }
            return result;
        }
        ...
        public ActionResult DQAResult()
        {
            ...
            var reports = Utility.GetUploadReport("Q4 FY18", ip);
        ...
        public ActionResult Analytics(string reportType = "Partners")
        {
            ...
            var datatable = Utility.GetFY18Analysis(ip, "Q4 FY18", reportType.ToLower().Contains("partners"));
        ...
        public string PostDQAFile()
        {
            ...
            try
            {
                ...
                Logger.LogInfo(" DQAQ4 FY2018,PostDQAFile", "processing dqa upload");
                    ...
                    foreach (string file in Request.Files)
                    {
                        ...
                        if (ext.ToUpper() == "XLS" || ext.ToUpper() == "XLSX" || ext.ToUpper() == "XLSM" || ext.ToUpper() == "ZIP")
                        {
                            string directory = System.Web.Hosting.HostingEnvironment
                                .MapPath("~/Report/Uploads/DQA Q4 FY18/"
                                + loggedinProfile.Organization.ShortName) + "/";
                            if (Directory.Exists(directory) == false)
                            {
                                Directory.CreateDirectory(directory);
                                    ...
                                    using (ZipFile zipFile = new ZipFile(fs))
                                    {
                                        ...
                                        foreach (ZipEntry zipEntry in zipFile)
                                        {
                                            ...
                                            if (entryExt.ToUpper() == "XLS" || entryExt.ToUpper() == "XLSX" || entryExt.ToUpper() == "XLSM")
                                            {
                                                ...
                                                messages += new BDQAQ4FY18().ReadWorkbook(extractedFilePath, loggedinProfile);
                                                countSuccess++;
                                            }
                                        }
                            ...
                            {
                                messages += new BDQAQ4FY18().ReadWorkbook(filePath, loggedinProfile);
                            }
                        }
                        else
                        {
        ...
        public ActionResult DQAAnalysisReport(string type)
        {
            ...
            cmd.Parameters.AddWithValue("@reportPeriod", "Q4 FY18");
        ...
        public ActionResult UMB_Partner_Report()
        {
            ...
            var partner_datatable = Utility.GetFY18Analysis(ip, "Q4 FY18", true);
            var umb_datatable = Utility.GetFY18Analysis(ip, "Q4 FY18", false);
        ...
        public async Task<ActionResult> DownloadDQATool(List<PivotTableModel> data)
        {
            ...
            string fileName = "DQA_Q4_" + profile.Organization.ShortName + ".zip";
            string directory = System.Web.Hosting.HostingEnvironment.MapPath("~/Report/Template/DQA FY2018 Q4/DQA_Q4_" + profile.Organization.ShortName);
            ...
            string file = await new BDQAQ4FY18().GenerateDQA(data, profile.Organization, fileName, directory, template, "Q4 FY18");
        ...
        public async Task<ActionResult> DownloadDQAResource(string fileType)
        {
            ...
            {
                case "DQAUserGuide":
                    filename = "Data Quality Assessment Userguide Q4 FY18.pdf";
                    break;
                case "PivotTable":
                    filename = "DATIM PIVOT TABLE FOR Q4 FY18.xlsx";
                    break;
                case "SummarySheet":
                    filename = "Summary Sheet FY18 Q4 DQA.pdf";
                    break;
            }
            string path = System.Web.Hosting.HostingEnvironment.MapPath("~/Report/Template/DQA FY2018 Q4/" + filename);
        ...
        public string RadetValidationData(int? draw, int? start, int? length)
        {
            ...
            List<dynamic> mydata2 = new Utility().RadetValidationWithNDR(searchModel, ip, period, startDate, endDate);
        ...
        [HttpPost]
        [AllowAnonymous]
        public string RADETAggregateData()
        {
            string period = "Q4 FY18";
            string startDate = "2018-07-01";
            string endDate = "2018-09-30";
