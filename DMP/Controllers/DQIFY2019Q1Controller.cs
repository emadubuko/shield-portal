...
{
    public class DQIFY2019Q1Controller : Controller
    {
        // GET: DQIFY2019Q1
        ...
        public ActionResult Index()
        {
            ...
            var reports = new QIEngine().RetrieveUpload(loggedinUser, "Q1 FY19");
            return View(reports);
        }
        ...
        public ActionResult DownloadDQITool()
        {
            ...
            var DQISites = new QIEngine().GetQISites("Q1 FY19", ip);
        ...
        {
            string fileName = "DQI_Q1_FY19_" + data.IP + ".xlsm";
            string directory = System.Web.Hosting.HostingEnvironment.MapPath("~/Report/Template/DQI/Q1 FY19/");
            string template = System.Web.Hosting.HostingEnvironment.MapPath("~/Report/Template/DQI/Q1 FY19/DQI TOOL_unlocked.xlsm");
                ...
                if (Request.Files.Count > 0)
                {
                    ...
                    foreach (string file in Request.Files)
                    {
                        ...
                        if (ext.ToUpper() == "XLS" || ext.ToUpper() == "XLSX" || ext.ToUpper() == "XLSM")
                        {
                            ...
                            messages += new QIEngine().ProcessUpload(filePath, userUploading, "Q1 FY19");
                        }
                        else
                        {
